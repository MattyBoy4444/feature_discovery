...
class _DescribedFeatureOverlayState extends State<DescribedFeatureOverlay> with TickerProviderStateMixin {
  ...
  double _backgroundRadius(Offset anchor) {
    ...
    final backgroundRadius =
        [_screenSize.width, widget.backgroundRadius, _screenSize.height].min * (isBackgroundCentered ? 1.0 : 0.7);
    return backgroundRadius;
  }

  Offset? _backgroundPosition(Offset anchor, ContentLocation contentLocation) {
    final width = [_screenSize.width, widget.backgroundRadius, _screenSize.height].min;
    final isBackgroundCentered = _isCloseToTopOrBottom(anchor);
  ...
  Widget _buildOverlay(Offset anchor) {
    ...
    final contentWidth = [_screenSize.width, widget.backgroundRadius, _screenSize.height].min;
